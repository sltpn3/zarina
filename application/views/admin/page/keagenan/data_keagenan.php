...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Order Keagenan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin'); ?>">Home</a></li>
                        <li class="breadcrumb-item active">Data Order Keagenan</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Order Keagenan</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-xs btn-danger" onclick="Hapus('<?= $d['idorder'] ?>');"><i class="fa fa-trash"></i> Hapus</a> 
                                        </td>
                                    </tr>
                                <?php $no++; endforeach ?>
