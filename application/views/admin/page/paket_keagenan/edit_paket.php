                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Keagenan</h3>
                        ...
                        <!-- /.card-header -->
                        <form role="form" method="post" action="<?= base_url('update/update_paket_keagenan') ?>" enctype="multipart/form-data" id="myForm">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?= $agen['fk'] ?>" disabled/>
                                            <input type="hidden" name="fk" id="fk" value="<?= $agen['fk'] ?>"/>
                                            <input type="hidden" name="id" id="id" value="<?= $agen['id'] ?>"/>
                                            <input type="hidden" name="slug" id="slug" value="<?= $agen['slug'] ?>"/>
                                        </div>
                                        ...
                                        <div class="form-group ck-editor__editable_inline mb-0 mb-0">
                                            ...
                                            <textarea id="compose-textarea" class="form-control mb-0 mb-0" name="deskripsi"><?= $agen['deskripsi'] ?></textarea>
                                        </div>

                                        <div class="form-group ck-editor__editable_inline mt-0 mt-0">
                                            <label>Informasi</label>
                                            <textarea id="compose-textarea100" class="form-control mt-0 mt-0" name="informasi"><?= $agen['informasi'] ?></textarea>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="minimal" class="form-control" id="minimal" value="<?= $agen['minimal'] ?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Repeat Order</label><br>
                                            <input type="number" name="repeat_order" class="form-control" id="repeat_order" value="<?= $agen['repeat_order'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="status" <?php if($agen['promo'] == 'on'): ?>checked<?php endif ?> data-bootstrap-switch data-off-color="danger" data-on-color="success" class="make-switch" id="checkbox" 
                                                 value="<?= $agen['promo'] ?>">
                                        </div>
...
$("#simpan").on('click', function(){
    ...
    $.ajax({
            url: "<?= base_url('get/get_slug_paket_keagenan/edit'); ?>",
            type: "POST",
