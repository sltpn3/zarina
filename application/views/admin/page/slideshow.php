...
<!--                     <div class="row">
                        <div class="col-md-6">
                            <p>Ukuran gambar 1366 x 600px</p>
                        </div>
                        <div class="col-md-6">
                        </div>
                    </div> -->
                        <a href="#" class="btn btn-default" data-toggle="modal" data-target="#modal-tambah">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php $no=1; foreach($slideshow as $d) : ?>
                    <tr>
                      <td width="80"><?= $no ?></td>
                      <td>
                          <a href="#" data-toggle="modal" data-target="#modal-img<?= $d['id'] ?>">
                            <img src="<?= base_url('assets/img/slideshow/' . $d['img']) ?>" class="img-fluid img-thumbnail" alt="<?= $d['nama'] ?>" width="50" height="50"/>
                          </a>
                      </td>
                      <td><?= $d['nama'] ?></td>
            ...
            <div class="modal fade" id="modal-edit<?= $d['id'] ?>">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?= base_url('update/slideedit') ?>" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group row col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        <img src="<?= base_url('assets/') ?>img/slideshow/<?= $d['img'] ?>" width="100" height="85" id="preview<?= $d['id'] ?>" class="img-thumbnail">
                                    </div>
                                    <div class="col-sm-9">
            ...
            <div class="modal fade" id="modal-img<?= $d['id'] ?>">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <img src="<?= base_url('assets/img/slideshow/' . $d['img']) ?>" style="display:block;width:100%;height:100%;object-fit:cover;" class="img-fluid" alt="<?= $d['nama'] ?>"/>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
            ...
            <div class="modal fade" id="modal-tambah">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?= base_url('tambah/slidetambah') ?>" enctype="multipart/form-data">
                            <div class="modal-body">
...
function Hapus(id) {
    swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo base_url('hapus/slidehapus'); ?>",
                    method: "GET",
                    data:"id="+id,
