          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Front Image</h3>
...
<!--                     <a href="#" class="btn btn-default" data-toggle="modal" data-target="#modal-tambah"><i
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php $no=1; foreach($front_foto as $d) : ?>
                    <tr>
                      <td width="80"><?= $no ?></td>
                      <td>
                          <a href="#" data-toggle="modal" data-target="#modal-img<?= $d['id'] ?>">
                            <img src="<?= base_url('assets/img/front/' . $d['img']) ?>" class="img-fluid img-thumbnail" alt="<?= $d['nama'] ?>" width="50" height="50"/>
                          </a>
                      </td>
                      <td><?= $d['nama'] ?></td>
                      ...
                      <td width="200">
                        <button class="btn btn-xs btn-success" data-toggle="modal" data-target="#modal-edit<?= $d['id'] ?>"><i class="fa fa-edit"></i> Edit
                        </button>
<!--                         <button class="btn btn-xs btn-danger" onclick="Hapus('<?= $d['id'] ?>');">
          ...
          <?php foreach ($front_foto as $d) : ?>

            <div class="modal fade" id="modal-edit<?= $d['id'] ?>">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Front Image</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form method="post" action="<?= base_url('update/frontedit') ?>" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group row col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        <img src="<?= base_url('assets/') ?>img/front/<?= $d['img'] ?>" width="100" height="85" id="preview<?= $d['id'] ?>" class="img-thumbnail">
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label>Text</label>
                                    <textarea class="form-control" name="text" id="text<?= $d['id'] ?>">
                                        <?= $d['text'] ?>
                                    </textarea>
            ...
            <div class="modal fade" id="modal-img<?= $d['id'] ?>">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <img src="<?= base_url('assets/img/front/' . $d['img']) ?>" style="display:block;width:100%;height:100%;object-fit:cover;" class="img-fluid" alt="<?= $d['nama'] ?>"/>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
            ...
            <div class="modal fade" id="modal-tambah">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?= base_url('tambah/fronttambah') ?>" enctype="multipart/form-data">
                            <div class="modal-body">
...
//             if (result.value) {
//                 $.ajax({
//                     url: "<?php echo base_url('update/frontedit'); ?>",
//                     method: "GET",
//                     data:"id="+id,
...
function Hapus(id) {
    swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo base_url('hapus/fronthapus'); ?>",
                    method: "GET",
                    data:"id="+id,
                    success: function (data) {
                        swal.fire({
